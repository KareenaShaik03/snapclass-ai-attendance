    ...
    for i,sub_node in enumerate(subjects):
        ...
        def unenroll_button():
            if st.button ("Unenroll from this course",type='tertiary',width='stretch',icon=':material/delete_forever:'):
                ...
                st.toast("Unenrolled from {sub['name']} successfully!")
                st.rerun()
        ...
        with st.spinner("AI is scanning....."):
            ...
            if num_faces == 0:
                ...
                if detected:
                    ...
                    show_recogintion = True

    if show_recogintion:
        with st.container(border=True):
            st.header('Register new profile')
            new_name = st.text_input("Enter your name",placeholder='Eg.Reena')
            ...
            try:
                audio_data = st.audio_input('Record a short phrase like I am present, My name is kareena.')
